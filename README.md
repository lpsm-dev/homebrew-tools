...
Nesse repositório, você encontrará uma coleção de `taps` (fórmulas) para o Homebrew, que permitem instalar pacotes que eu criei e que não estão disponíveis no repositório oficial do Homebrew.
